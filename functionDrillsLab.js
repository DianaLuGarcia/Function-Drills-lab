...
const colorRating = favColorFinder('black');
...
console.log(uppCase(sampleString));
...
return totalFrogs.round();
}
let gold = 1000
console.log('You can purchase',potter(gold),'frogs!');
